      ...
      function (e, a, t) {
        (e = t.nmd(e)).exports = (function () {
          ...
          function le(e, a) {
            return function (t) {
              return null != t
                ? (he(this, e, t), n.updateOffset(this, a), this)
                : Me(this, e);
            };
          }
          function Me(e, a) {
          ...
          function da(e, a) {
            return e
              ? i(this._monthsShort)
                ...
                : this._monthsShort[sa.test(a) ? "format" : "standalone"][
                    e.month()
                  ]
              : i(this._monthsShort)
              ? this._monthsShort
          ...
          function Ma(e) {
            return this._monthsParseExact
              ...
              : (_(this, "_monthsShortRegex") || (this._monthsShortRegex = na),
          ...
          R("H", ["HH", 2], 0, "hour"),
            ...
            Je("hmmss", function (e, a, t) {
              var s = e.length - 4,
                n = e.length - 2;
              (a[Be] = me(e.substr(0, s))),
                (a[qe] = me(e.substr(s, 2))),
                (a[Ke] = me(e.substr(n))),
                (Y(t).bigHour = !0);
            }),
            Je("Hmm", function (e, a, t) {
              var s = e.length - 2;
              (a[Be] = me(e.substr(0, s))), (a[qe] = me(e.substr(s)));
            }),
            Je("Hmmss", function (e, a, t) {
              var s = e.length - 4,
                n = e.length - 2;
          ...
          function At(e) {
            ...
            if (t) {
              if (
                ((a = jt(t[4], t[3], t[2], t[5], t[6], t[7])), !Ot(t[1], a, e))
              )
                return;
              (e._a = a),
          ...
          function Jt(e) {
            ...
            null != (a = e._w).GG || null != a.W || null != a.E
              ? ((r = 1),
                (i = 4),
                (t = Ft(a.GG, e._a[Ue], ga(Kt(), 1, 4).year)),
                (s = Ft(a.W, 1)),
          ...
          function ss(e) {
            ...
            for (a in e)
              if (
                _(e, a) &&
                (-1 === Ie.call(ts, a) || (null != e[a] && isNaN(e[a])))
              )
                return !1;
            for (t = 0; t < n; ++t)
              if (e[ts[t]]) {
          ...
          function Ms(e, a) {
            ...
            return a._isUTC
              ? ((t = a.clone()),
                (s =
                  (T(e) || l(e) ? e.valueOf() : Kt(e).valueOf()) - t.valueOf()),
          ...
          function Zs(e, a, t) {
            ...
            switch (
              ((n = 6e4 * (s.utcOffset() - this.utcOffset())), (a = ne(a)))
            ) {
              case "year":
                r = $s(this, s) / 12;
                break;
          ...
          function tn(e, a) {
            return this.isValid() && ((T(e) && e.isValid()) || Kt(e).isValid())
              ? Ss({ to: this, from: e }).locale(this.locale()).humanize(!a)
          ...
          function nn(e, a) {
            return this.isValid() && ((T(e) && e.isValid()) || Kt(e).isValid())
              ? Ss({ from: this, to: e }).locale(this.locale()).humanize(!a)
              : this.localeData().invalidDate();
          }
          function rn(e) {
            return this.to(Kt(), e);
            ...
            Je(["yo"], function (e, a, t, s) {
              ...
              t._locale._eraYearOrdinalRegex &&
                ...
                t._locale.eraYearOrdinalParse
                  ? (a[Ue] = t._locale.eraYearOrdinalParse(e, n))
                  : (a[Ue] = parseInt(e, 10));
            }),
            R(0, ["gg", 2], 0, function () {
          ...
          function xr(e) {
            ...
            if ("month" === (e = ne(e)) || "quarter" === e || "year" === e)
              switch (
                ((a = this._days + s / 864e5), (t = this._months + Hr(a)), e)
              ) {
                case "month":
                  return t;
                case "quarter":
    ...
    document.addEventListener(
      ...
      function () {
        if ("complete" === document.readyState) {
          ...
          var e = document.getElementById("js-date");
          e &&
            setInterval(function () {
              requestAnimationFrame(function () {
                var t = a()().format("HH:mm:ss");
                e.innerText = t;
              });
            }, 1e3);
        }
